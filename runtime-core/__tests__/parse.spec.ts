...
import { baseParse, Namespaces } from '../parse'
// import type { Program } from '@babel/types'
import { describe, test, expect, vi } from 'vitest'

describe('compiler: parse', () => {
  describe('Text', () => {
    test.only('simple text', () => {
  ...
  describe.skip('decodeEntities option', () => {
  ...
  describe.skip('whitespace management when adopting strategy condense', () => {
  ...
  describe.skip('whitespace management when adopting strategy preserve', () => {
    const parse = (content: string, options?: ParserOptions) =>
      baseParse(content, {
        whitespace: 'preserve',
        ...options,
  ...
  describe.skip('expression parsing', () => {
    test('interpolation', () => {
